...
export default function Ranking() {
  ...
  for (let i = 0; i < torneosDelUser.length; i++) {
    RowsDeRanking.push(
      createDataTorneo(torneosDelUser[i].TorneoID, torneosDelUser[i].Nombre)
    );
  }
    ...
    <div>
      <TableContainer component={Paper} id="tablita">
        <div class="d-flex px-2 w-75 align-items-center align-self-center mt-2">
          ...
          <form className="px-2 w-75 d-flex">
            <select
              className="custom-select mt-2 pr-5 "
              id="torneoSelect"
              onChange={cambioId}
            >
            ...
            <button
              type="submit"
              className="btn btn-primary mt-2 mx-2 h-25 d-inline-block"
      ...
      <div className="d-flex flex-column align-items-center mt-5">
        <div style={{ fontSize: "1.3rem", fontWeight: "bold" }}>
          <span>¡Comparte el torneo con tus amigos!</span>
        </div>
