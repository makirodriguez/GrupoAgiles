...
const sql_insert = `INSERT OR REPLACE INTO Logros (LogroID, NombreLogro, ImgPath, Otorgado) VALUES
    (1, 'Ganador del torneo Global', '', 0),
    (2, 'Ganador del torneo de Amigos', '',0),
    (3, 'Perfect', '',0),
    (99, 'Tronco', '',0)`
  db.run(sql_insert, err => {
    if (err) {
